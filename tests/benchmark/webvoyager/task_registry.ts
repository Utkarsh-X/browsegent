...
export const WEBVOYAGER_STABLE_SLICES: Record<WebVoyagerBenchmarkSlice, readonly string[]> = {
  ...
  fresh50: [
    'Wolfram Alpha--2', 'Wolfram Alpha--3', 'Wolfram Alpha--15', 'Wolfram Alpha--20',
    'GitHub--3', 'GitHub--8', 'GitHub--14', 'GitHub--18',
    'ArXiv--6', 'ArXiv--17', 'ArXiv--27', 'ArXiv--30',
    'Cambridge Dictionary--1', 'Cambridge Dictionary--6', 'Cambridge Dictionary--17', 'Cambridge Dictionary--21',
    'Google Search--3', 'Google Search--7', 'Google Search--18', 'Google Search--21',
    'Allrecipes--4', 'Allrecipes--20', 'Allrecipes--24',
    'Amazon--2', 'Amazon--21', 'Amazon--24',
    'Apple--12', 'Apple--26', 'Apple--27',
    'BBC News--5', 'BBC News--11', 'BBC News--25',
    'Booking--3', 'Booking--21', 'Booking--24',
    'Coursera--1', 'Coursera--15', 'Coursera--19',
    'ESPN--9', 'ESPN--11', 'ESPN--15',
    'Google Flights--4', 'Google Flights--14', 'Google Flights--19',
    'Google Map--2', 'Google Map--8', 'Google Map--20',
    'Huggingface--13', 'Huggingface--14', 'Huggingface--25',
  ],
  'fresh50-stable': [
    'Wolfram Alpha--2', 'Wolfram Alpha--3', 'Wolfram Alpha--15', 'Wolfram Alpha--20',
    'GitHub--3', 'GitHub--8', 'GitHub--14', 'GitHub--18',
